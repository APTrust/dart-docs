...
![Default files list](../../img/jobs/files_default.png)
...
![Files list showing open directory](../../img/jobs/files_directory.png)
...
![Files list without hidden files](../../img/jobs/files_directory_no_hidden.png)

This is the same directory with hidden files displayed:

![Files list showing hidden files](../../img/jobs/files_directory_with_hidden.png)
...
![File jump menu](../../img/jobs/files_jump_menu.png)
