...
!!! note
    This document describes uploading files as part of the bagging process.
    For information about upload-only jobs, which do not involve bagging, see
    [Upload-Only Jobs](upload_jobs.md)

When running a job, you can specify one or more upload targets on the uploads page. Simply check the box beside each target you want to upload to.
